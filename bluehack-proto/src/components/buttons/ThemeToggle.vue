<template>
    <label class="swap swap-rotate">
        ...
        <div v-if="themeBeingUsed === lightTheme" @click="toggleTheme" class="swap-off btn btn-ghost btn-circle" >
        ...
        <div v-else @click="toggleTheme" class="swap-on btn btn-ghost btn-circle">
...
export default {
    ...
    methods: {
        toggleTheme() {
            this.themeBeingUsed = this.themeBeingUsed === this.lightTheme ? this.darkTheme : this.lightTheme;
            document.documentElement.setAttribute('data-theme', this.themeBeingUsed);
        },
    },
};
</script>
