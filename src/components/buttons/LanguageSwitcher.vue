<template>
    <label class="swap swap-rotate">
        ...
        <div v-if="lang === 'pt'" @click="selectLang('en')" class="swap-off btn btn-ghost btn-circle" >
            <svg class="fill-current w-6 h-6" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="flag-icons-gb" viewBox="0 0 640 480">
        ...
        <div v-else @click="selectLang('pt')" class="swap-on btn btn-ghost btn-circle">
            <svg class="fill-current w-6 h-6" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="flag-icons-pt" viewBox="0 0 640 480">
